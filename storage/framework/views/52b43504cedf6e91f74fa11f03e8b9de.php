...
<head>
    ...
    <!-- <link rel="stylesheet" href="<?php echo e(url('front/fontawesome-free-6.3.0-web/css/all.min.css')); ?>"> -->
...
<body>
    ...
    <script src="<?php echo e(url('aczreviews/front//bootstrap-5.0.2-dist/bootstrap.min.js')); ?>" ></script>
    <script src="<?php echo e(url('aczreviews/front/js/custom.js')); ?>" ></script>
    <script src="<?php echo e(url('aczreviews/front/js/jquery-3.7.0.min.js')); ?>" ></script>
