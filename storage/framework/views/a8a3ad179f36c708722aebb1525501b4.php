                    ...
                    <div class="detail-gal-wrapper">
                        <div class="detail-gal">
                            <div class="detail-main-img">
                                <img src="<?php echo e(url('aczreviews/front/images/sample_images/product-1.jpg')); ?>" alt="">
                            </div>
                            <div class="detail-thumb">
                                <img src="<?php echo e(url('aczreviews/front/images/sample_images/gal-1-1.jpg')); ?>" alt="">
                                <img src="<?php echo e(url('aczreviews/front/images/sample_images/gal-1-2.jpg')); ?>" alt="">
                                <img src="<?php echo e(url('aczreviews/front/images/sample_images/gal-1-3.jpg')); ?>" alt="">
                                <img src="<?php echo e(url('aczreviews/front/images/sample_images/gal-1-4.jpg')); ?>" alt="">
                                <img src="<?php echo e(url('aczreviews/front/images/sample_images/gal-1-5.jpg')); ?>" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-xs-12 ">
                                            <div class="your-review-wrapper mt-3">
                                                ...
                                                <form action="javascript:void(0);" id = "guest-rating-form"><?php echo csrf_field(); ?>
                                                ...
                                                <form action="javascript:void(0);" id = "user-rating-form"><?php echo csrf_field(); ?>
