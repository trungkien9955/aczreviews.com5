...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{url('FlowerShop/front/images/icon_images/logo-icon-2.png')}}">
...
<body>
    <div id="loading">
    <img id="loading-image" src="{{url('FlowerShop/front/images/Iphone-spinner-2.gif')}}" alt="Loading..." />
    </div>
