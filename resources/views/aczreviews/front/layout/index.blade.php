        ...
        <div class="container overflow-hidden">
            <div class="home-banner">
                <div class="home-banner-wrapper owl-carousel owl-carousel-home-banners">
                    <img src="{{url('aczreviews/front/images/banner_images/banner-derma-2.png')}}" alt="">
                    <img src="{{url('aczreviews/front/images/banner_images/home-banner-3.png')}}" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="products-section-wrapper">
                <div class="home-department-wrapper">
                    ...
                    <div class="home-department-banner">
                        <img src="{{url('aczreviews/front/images/banner_images/lipstick-banner-2.png')}}" alt="">
                    </div>
                ...
                <div class="home-department-wrapper">
                    ...
                    <div class="home-department-banner">
                        <img src="{{url('aczreviews/front/images/banner_images/men-beauty-banner-4.png')}}" alt="">
                    </div>
                    <div class="home-department-content">
                        <div class="row gy-2">
                            <div class="col-lg-3 col-md-3 col-xs-6">
                ...
                <div class="home-department-wrapper home-department-wrapper-supplements">
                    ...
                    <div class="home-department-banner">
                        <img src="{{url('aczreviews/front/images/banner_images/supplements-banner.png')}}" alt="">
                    </div>
                    <div class="home-department-content">
                        <div class="row gy-2">
                ...
                <div class="home-department-wrapper home-department-wrapper-vitamins">
                    ...
                    <div class="home-department-banner">
                        <img src="{{url('aczreviews/front/images/banner_images/vitamins-banner-8.png')}}" alt="">
                    </div>
                    <div class="home-department-content">
                        <div class="row gy-2">
                            <div class="col-lg-2 col-md-2 col-xs-4">
                ...
                <div class="home-department-wrapper home-department-wrapper-sport">
                    ...
                    <div class="home-department-banner">
                        <img src="{{url('aczreviews/front/images/banner_images/sport-banner-2.png')}}" alt="">
                    </div>
                    <div class="home-department-content">
